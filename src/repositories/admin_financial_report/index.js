...
exports.getApprovedApplicationsCountAdmin = async (userId, filters = {}) => {
...
exports.getWalletTopupsTotalAdmin = async (userId, filters = {}) => {
...
exports.getTotalDepositsAdmin = async (userId, filters = {}) => {
   const { platform, status, fromDate, toDate } = filters;
   const dateFilter = buildDateFilter(fromDate, toDate);
   ...
   const statusFilter = status && status !== 'all' ? { status } : { status: 'approved' };
   const userFilter = userId && userId !== 'all' ? { userId } : {};
   const appUserFilter = userId && userId !== 'all' ? { user: userId } : {};
...
exports.getTotalRefundsAdmin = async (userId, filters = {}) => {
...
exports.getDepositRecordsAdmin = async (userId, filters = {}) => {
   const { platform, status, fromDate, toDate } = filters;
   const dateFilter = buildDateFilter(fromDate, toDate);
...
exports.getApplicationsReportAdmin = async (userId, filters = {}) => {
   const { platform, status, fromDate, toDate } = filters;
   const dateFilter = buildDateFilter(fromDate, toDate);
...
exports.getRefundsReportAdmin = async (userId, filters = {}) => {
   const { platform, fromDate, toDate } = filters;
   const dateFilter = buildDateFilter(fromDate, toDate);
...
exports.getAdminFinancialReport = async (userId, filters = {}) => {
   const [
      ...
      exports.getApprovedApplicationsCountAdmin(userId, filters),
      exports.getWalletTopupsTotalAdmin(userId, filters),
      exports.getTotalDepositsAdmin(userId, filters),
      exports.getTotalRefundsAdmin(userId, filters),
      exports.getDepositRecordsAdmin(userId, filters),
      exports.getApplicationsReportAdmin(userId, filters),
      exports.getRefundsReportAdmin(userId, filters),
   ]);
