...
/**
 * @swagger
 * /api/admin/get-all-facebook-accounts:
 *   get:
 *     summary: Admin fetch all Facebook ad accounts with filters
 *     tags:
 *       - Admin Ad Accounts
 *     security:
 *       - bearerAuth: []
 ...
 *     responses:
 *       200:
 *         description: Facebook ad accounts fetched successfully
 *         content:
 *           application/json:
 *             example:
 *               success: true
...
/**
 * @swagger
 * /api/admin/get-all-google-accounts:
 *   get:
 *     summary: Admin fetch all Google ad accounts with filters
 *     tags:
 *       - Admin Ad Accounts
 *     security:
 *       - bearerAuth: []
 ...
 *     responses:
 *       200:
 *         description: Google ad accounts fetched successfully
 *         content:
 *           application/json:
 *             example:
 *               success: true
